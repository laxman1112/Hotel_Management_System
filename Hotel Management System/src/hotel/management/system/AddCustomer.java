...
public class AddCustomer extends JFrame implements ActionListener{
    ...
    AddCustomer(){
        ...
        JLabel lbllcountry =new JLabel("Country");
        lbllcountry.setBounds(35,240,100,20);
        lbllcountry.setFont(new Font("Raleway",Font.PLAIN,20));
        add(lbllcountry);
        ...
        checkintime.setFont(new Font("Ralway",Font.PLAIN,16));
        add(checkintime);
